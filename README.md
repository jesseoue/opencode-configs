...
**v1.5.36** · CLI **`oc`** · identity `jesseoue/opencode-configs`
...
| | |
| --- | --- |
| **Pins** | OpenConfig `1.5.36` · OpenCode `1.18.5+` · OmO `oh-my-openagent@4.19.1` · `@opencode-ai/plugin` `1.18.5` |
...
| --- | --- | --- |
| OpenConfig | `versions.json` → `opencode_configs` | `1.5.36` |
