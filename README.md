...
**v1.5.79** · CLI **`oc`** · identity `jesseoue/opencode-configs`
...
| | |
| --- | --- |
| **Pins** | OpenConfig `1.5.79` · OpenCode `1.18.30+` · OmO `oh-my-openagent@4.19.4` · `@opencode-ai/plugin` `1.18.30` |
| **Default lead** | `sisyphus` (GLM 5.3) |
| **Config path** | `/Users/Shared/opencode-configs` · `~/.config/opencode` and `~/.omo` are symlinks into it |
...
| --- | --- | --- |
| OpenConfig | `versions.json` → `opencode_configs` | `1.5.79` |
