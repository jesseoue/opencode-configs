# Core stance (all sessions) — OpenConfig 1.5.16
...
- `/goal` objectives ≤1800 chars (OmO hard-caps at 2000). Never paste plan files into the objective — see `prompts/goal.md`.
